...
- React Bootstrap – Used for CSS formatting and formatting of some site components, such as the navbar and the footer, under the MIT License.
- Eslint VS Code Extension – for JavaScript code suggestions and code formatting

UI and Art Asset Attributions

- Site Logo - Created by Zach Hubbard using Photoshop CC
...
- BlenderDonut.mp4 - Videocreated by Zach Hubbard through completion of Blender Guru's Beginner Blender 4.0 Tutorial Playlist/Course on YouTube
- SodaCan.png - created by Zach Hubbard using Photoshop CC
...
- WVQuest.png -  UI Designed by Jaskson Sigler and implemented into Unity by Tessla Muir
- RegistrationWVQuest.png -  UI Designed by Jaskson Sigler and implemented into Unity by Tessla Muir
- AppalachianSeedLaunch.png - Background Image created by Heather Cole for 2023 Global Game Jam
- RampCrash.png - Image for Cart Smash - 2024 Global Game Jam Submission, attributions found on project page.