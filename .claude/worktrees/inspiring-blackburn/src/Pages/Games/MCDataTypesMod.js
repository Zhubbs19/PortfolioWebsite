        ...
        <Container maxWidth="xl" className="about-content">
          ...
          <Grid container spacing={4} sx={{ mt: 2 }}>
            <Grid item xs={12}>
              ...
              <div className='info-item'>
                <ul>
                  <li>First iteration of Block/Item models and textures for each data type</li>
                  <li>Functional data storage block UI for Integers, Long integers, Floats, Doubles, and Strings</li>
                  <li>Guidebook item functionality and basic UI when right-clicking item or through a key bind</li>
                  <li>Modded Blocks and Items present in Minecraft creative mode inventory UI</li>
                </ul>
              </div>
            </Grid>
          </Grid>
          ...
          <Grid container spacing={4} sx={{ mt: 2 }}>
            <Grid item xs={12}>
              ...
              <div className='info-item'>
                <ul>
                  <li>Original Game - Minecraft: Java Edition - Version 1.21+, Mojang, 2011</li>
                  <li>IntelliJ IDEA - Java Programming IDE</li>
                  <li>NeoForge - Community-made Mod Development Kit for Minecraft</li>
                  <li>Blockbench - 3D low-poly modeling software used to model in-game blocks and items and create textures</li>
                  <li>Git/GitHub - for Version Control Management</li>
                </ul>
              </div>
            </Grid>
          </Grid>
