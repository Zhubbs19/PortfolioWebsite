      ...
      <div className="about-content">
        <Grid container direction="row" justifyContent="center" className='about-grid'>
          <Grid item className='info-item'>
            <VideoEmbed videoURL="https://drive.google.com/uc?id=126AtST8CIzQISODfxTkthe8DrFR7xvrU"></VideoEmbed>
          </Grid>
          <Grid item className='info-item'>
            <p>Appalachian Seed-A-Pult is a 2D WebGL seed-launching game where you are tasked with catapulting a seed to the correct type of soil where it is fertile and is able grow. 
            ...
            <div className="list"></div>
              ...
              <iframe src="https://itch.io/embed/1911063" width="552" height="167"><a href="https://gdimwvu.itch.io/appalachian-seed-a-pult">Appalachian Seed-A-Pult by GDIM</a></iframe></p>
          </Grid>
        </Grid>
      </div>
      <Footer />
