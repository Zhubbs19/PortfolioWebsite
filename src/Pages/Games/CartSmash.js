...
import CartSmashImg1 from '../../Images/RampCrash2.png';
      ...
      <div className="about-content">
        <Grid container spacing={6} direction="row" className='about-grid'>
          ...
          <Grid item className='CartSmashInfo' xs={12} sm={12} md={12} lg={12} xl={6}>
            ...
            <a style={{fontWeight:"bold"}} href="https://globalgamejam.org/games/2024/cart-smash-2">Cart Smash - Global Game Jam Submission</a>
