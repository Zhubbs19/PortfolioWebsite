  ...
  return (
    ...
    <div className="Global">
      ...
      <Grid item className='grid-item'>
        ...
        <Grid item className='grid-item'>
          <p className="grid-item">Appalachian Seed-A-Pult is a 2D WebGL seed-launching game where you are tasked with engaging in dialogue and retrieving collectibles with the various ghosts in a post-apocalyptic world. This game was created as part of Mon River Games&apos participation in the 2023 Global Game Jam, with 4 members participating over 2 days.
